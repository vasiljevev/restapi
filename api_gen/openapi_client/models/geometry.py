...
class Geometry(BaseModel):
    ...
    coordinates: Optional[conlist(GeometryCoordinatesInner)] = Field(None, alias="Coordinates")
    ...
    def from_dict(cls, obj: dict) -> Geometry:
        ...
        _obj = Geometry.parse_obj({
            "type": obj.get("Type"),
            "coordinates": [GeometryCoordinatesInner.from_dict(_item) for _item in obj.get("Coordinates")] if obj.get("Coordinates") is not None else None
        })
        return _obj
