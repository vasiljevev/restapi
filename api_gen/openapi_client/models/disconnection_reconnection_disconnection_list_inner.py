...
class DisconnectionReconnectionDisconnectionListInner(BaseModel):
    ...
    __properties = ["ActionType", "DiscconectionId", "Description", "Type", "Reason", "Date", "Area", "Initiator", "Performer", "ConsumerId", "UsagePoints"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> DisconnectionReconnectionDisconnectionListInner:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> DisconnectionReconnectionDisconnectionListInner:
        """Create an instance of DisconnectionReconnectionDisconnectionListInner from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return DisconnectionReconnectionDisconnectionListInner.parse_obj(obj)

        _obj = DisconnectionReconnectionDisconnectionListInner.parse_obj({
