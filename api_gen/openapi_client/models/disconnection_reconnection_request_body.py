...
class DisconnectionReconnectionRequestBody(BaseModel):
    """
    4.1 Параметры тела запроса для сервиса Disconnection/Reconnection  # noqa: E501
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> DisconnectionReconnectionRequestBody:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> DisconnectionReconnectionRequestBody:
        """Create an instance of DisconnectionReconnectionRequestBody from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return DisconnectionReconnectionRequestBody.parse_obj(obj)

        _obj = DisconnectionReconnectionRequestBody.parse_obj({
            "service": Service.from_dict(obj.get("Service")) if obj.get("Service") is not None else None,
            "params": DisconnectionReconnectionRequestBodyParams.from_dict(obj.get("Params")) if obj.get("Params") is not None else None
        })
        return _obj
