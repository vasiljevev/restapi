...
class ConsumersInnerUsagePointsInner(BaseModel):
    ...
    is_sdp: Optional[StrictBool] = Field(None, alias="IsSDP")
    ...
    __properties = ["ActionType", "UsagePointID", "Name", "OrganizationID", "IsSDP", "VoltageLevel", "VoltageClass", "ServiceLocationID", "SubstationCodeTm", "SubstationName", "TransformerName", "BayCodeTm", "BayName", "LineCodeTm", "LineName", "TowerCodeTm", "TowerName", "Remark", "Geometry"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ConsumersInnerUsagePointsInner:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ConsumersInnerUsagePointsInner:
        """Create an instance of ConsumersInnerUsagePointsInner from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ConsumersInnerUsagePointsInner.parse_obj(obj)

        _obj = ConsumersInnerUsagePointsInner.parse_obj({
